...
public class Comment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userPhoneNumber = Woyalla.myDatabase.get_Value_At_Top(Database.Table_USER, Database.USER_FIELDS[1]);
    ...
    private void performSend() {
        ...
        body = RequestBody.create(mediaType,
                "clientPhoneNumber="+getUserPhoneNumber() +
                        "&comment=" + comment +
                        "&rate="+getRating());

        //create the request object from http post
        request = new Request.Builder()
                .url(Woyalla.API_URL + "ratings/create")
                .post(body)
